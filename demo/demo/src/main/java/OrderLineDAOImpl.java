...
public class OrderLineDAOImpl implements OrderLineDAO {
    ...
    @Override
    public void insert(OrderLineController o) {
    ...
    @Override
    public List<OrderLineController> findAll() {
        List<OrderLineController> list = new ArrayList<>();
        for (Document doc : collection.find()) {
            list.add(new OrderLineController(
                    doc.getString("id"),
