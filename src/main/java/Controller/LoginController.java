...
public class LoginController {
    ...
    public void GotoRegister(ActionEvent event) {
        try {
            root = FXMLLoader.load(getClass().getResource("/com/alleviationfixed/Register.fxml"));
    ...
    public void GotoMainMenu(ActionEvent event) {
        try {
            root = FXMLLoader.load(getClass().getResource("/com/alleviationfixed/Alleviation.fxml"));
            stage = (Stage)((Node)event.getSource()).getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
    ...
    public void handleLogButton(ActionEvent event) {
        ...
        if (!errors.isEmpty()) {
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/alleviationfixed/UserInterface.fxml"));
